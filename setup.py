...
class develop(setuptools.command.develop.develop):
    def _make_symlinks(self, sources):
        here = os.path.abspath(os.path.dirname(__file__))
        subdir = os.path.join(here, 'sconstool', 'gnuplot')
...
setup(
        name='scons-tool-gnuplot',
        version=about['__version__'],
        package_dir={'sconstool.gnuplot': '.'},
        packages=['sconstool.gnuplot'],
        namespace_packages=['sconstool'],
        description='Gnuplot tool for SCons',
        long_description=readme,
        long_description_content_type='text/x-rst',
        url='https://github.com/ptomulik/scons-tool-gnuplot',
